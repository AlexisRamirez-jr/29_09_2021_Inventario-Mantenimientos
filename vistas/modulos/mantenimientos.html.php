      ...
      <div class="box-body">
       ...
       <table class="table table-bordered table-striped dt-responsive tablas">
        ...
        <tbody>
          ...
          <tr>
            <td>1</td>
            <td><img src="vistas/img/mantenimientos/default/anonymous.png" class="img-thumbnail" width="40px"></td>
            <td>0001</td>
          ...
          <div class="box-body">
             ...
             <div class="form-group row">
                ...
                <div class="col-xs-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" class="form-control input-lg" name="nuevoPrecioCompra" min="0" placeholder="Costo de mantenimiento" required>
            ...
            <!-- ENTRADA PARA SUBIR FOTO -->
             ...
             <div class="form-group">
              ...
              <img src="vistas/img/mantenimientos/default/anonymous.png" class="img-thumbnail" width="100px">
