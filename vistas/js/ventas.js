...
EDITAR Vehiculos
=============================================*/
$(".tablas").on("click", ".btnEditarVehiculos", function(){
    ...
    $.ajax({
      ...
      success:function(respuesta){
		...
		$("#editarAño").val(respuesta["anio"]);
		$("#editarPrecio").val(respuesta["precioadquisicion"]);
	   $("#editarFecha").val(respuesta["fechaadquirido"]);
	  ...
	  $.ajax({
     	...
     	url:"ajax/productos.ajax.php",
      	...
      	success:function(respuesta){
      	    ...
      	    $(nuevoPrecioProducto).val(respuesta["precio_unidad"]);
      	    $(nuevoPrecioProducto).attr("precioReal", respuesta["precio_total"]);
