...
class ModeloMantenimientos{
	...
	static public function mdlMostrarMantenimientos($tabla, $item, $valor, $orden){
	...
	static public function mdlEliminarMantenimientos($tabla, $datos){
	...
	static public function mdlMostrarSumaMantenimientos($tabla){
