...
/*=============================================
	...
	public function ctrDescargarEmpleados(){

		if(isset($_GET["Lista_Empleados"])){
			...
			echo utf8_decode("<table border='0'> 
					...
					<td style='font-weight:bold; border:1px solid #eee;'>FECHA DE NACIMIENTO</td>
					<td style='font-weight:bold; border:1px solid #eee;'>SALARIO</td>		
			...
			foreach ($respuesta as $row => $item){
			 ...
			 echo utf8_decode("<tr>
						...
						<td style='border:1px solid #eee;'>$ ".number_format($item["salario"],2)."</td>
